...
const ChallengeCard = ({ challenge, onChallengeClick, detailView }) => {
  const cardClass = detailView ? "col-xs-10 col-sm-8 col-md-5 col-lg-5 card overflow-hidden"
          ...
          <div
            ...
            <div className="card-body">
              ...
              <div className="card-title fs-5 fw-bold pb-2">
                <span className="text-secondary">#{challenge.id}</span> {challenge.name.toUpperCase()}
              </div>
              <h6 className="card-subtitle mb-2 text-muted pb-2">{challenge.country}</h6>
              <p className="card-text overflow-hidden text-muted pb-2" style={{height:"100px"}}>
