...
export const CHANGES_UPLOAD_LIMIT =
  Number(process.env.REACT_APP_CHANGES_UPLOAD_LIMIT || 25);

export const MAX_CHALLENGE_AREA =
  Number(process.env.REACT_APP_MAX_CHALLENGE_AREA || 200);
